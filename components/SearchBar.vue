<template>
  <div class="mx-auto mt-11">
    <div
      class="flex flex-col lg:flex-row border lg:rounded-full rounded-3xl 2xl:p-2 xl:p-2 lg:p-2 md:p-2 p-6 border-gray-300"
    >
      ...
      <div
        class="lg:flex flex-col justify-center lg:border-r lg:pl-4 md:pl-2 border-gray-300"
      >
      ...
      <div
        class="lg:flex flex-col justify-center lg:pl-4 md:pl-2 lg:pr-6 md:pr-2"
      >
        <label class="text-black font-extrabold text-15 sm:text-sm">Who</label>
        <input
          type="text"
          placeholder="Add number of guests"
          class="outline-none bg-transparent text-12 sm:text-sm font-medium lg:pl-0 pl-2"
          v-model.number="who"
      ...
      <button
        class="rounded-full lg:mt-0 mt-4 lg:p-3 md:p-2 p-1 lg:mr-1 text-lg bg-FF7171 flex items-center justify-center"
        @click="handleSearch"
      >
        <UIcon
          name="i-heroicons-magnifying-glass"
          class="text-white lg:text-3xl md:text-xl sm:text-lg text-base"
        />
      </button>
    </div>
  </div>
